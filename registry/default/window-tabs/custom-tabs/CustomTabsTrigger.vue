<template>
  <TabsTrigger
    ...
    <slot />
    <Button class="group-hover:opacity-80 opacity-0 hover:opacity-100 cursor-pointer absolute right-0 top-1/2 -translate-y-1/2" data-vitest-id="custom-tabs-trigger-close-button" v-if="isHideable" @click="handleCloseTab" variant="link">
